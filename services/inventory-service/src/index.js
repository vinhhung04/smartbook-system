...
app.post('/api/inventory/inbound', authorizeAnyPermission(['inventory.receiving.write', 'inventory.stock.write']), async (req, res) => {
...
app.post('/api/inventory/outbound', authorizeAnyPermission(['inventory.transfer.write', 'inventory.stock.write']), async (req, res) => {
