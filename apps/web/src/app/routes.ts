...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: "inventory", loader: requireRoleOrPermissionLoader(ROUTE_ACCESS.inventoryRead), Component: InventoryPage },
      { path: "orders", loader: requireRoleOrPermissionLoader(ROUTE_ACCESS.managerStockDecision), Component: OrdersPage },
      { path: "orders/new", loader: requireRoleOrPermissionLoader(ROUTE_ACCESS.managerStockDecision), Component: GoodsReceiptPage },
      { path: "orders/:id", loader: requireRoleOrPermissionLoader(ROUTE_ACCESS.managerStockDecision), Component: OrderDetailPage },
      ...
      { path: "putaway", loader: requireRoleOrPermissionLoader(ROUTE_ACCESS.managerStockDecision), Component: PutawayPage },
      { path: "putaway/:id", loader: requireRoleOrPermissionLoader(ROUTE_ACCESS.managerStockDecision), Component: PutawayDetailPage },
      { path: "putaway/:id/execute", loader: requireRoleOrPermissionLoader(ROUTE_ACCESS.managerStockDecision), Component: PutawayExecutePage },
      ...
      { path: "picking", loader: requireRoleOrPermissionLoader(ROUTE_ACCESS.managerStockDecision), Component: PickingPage },
      { path: "order-requests", loader: requireRoleOrPermissionLoader(ROUTE_ACCESS.orderRequests), Component: OrderRequestsPage },
      { path: "movements", loader: requireRoleOrPermissionLoader(ROUTE_ACCESS.inventoryRead), Component: MovementsPage },
      { path: "outbound", loader: requireRoleOrPermissionLoader(ROUTE_ACCESS.managerStockDecision), Component: OutboundPage },
      { path: "warehouses", loader: requireRoleOrPermissionLoader(ROUTE_ACCESS.warehouseWrite), Component: WarehousesPage },
      { path: "shelves", loader: requireRoleOrPermissionLoader(ROUTE_ACCESS.inventoryRead), Component: ShelvesPage },
