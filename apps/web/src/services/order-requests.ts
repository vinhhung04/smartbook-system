...
export const orderRequestService = {
  ...
  previewOutboundReferenceCode: async (referenceType: OutboundReferenceType) => {
    const response = await inventoryAPI.get('/api/order-requests/outbound/reference-code/preview', {
