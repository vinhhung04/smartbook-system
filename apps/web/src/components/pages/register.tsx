    ...
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-white">
      ...
      <div className="flex flex-col items-center justify-center p-8">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-sm">
          ...
          <h2 className="text-[24px] mb-2 tracking-[-0.02em]" style={{ fontWeight: 700 }}>Create your account</h2>
          <p className="text-slate-500 mb-8">Join SmartBook to streamline your inventory</p>

          <div className="space-y-4 mb-6">
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="text-[12px] text-slate-600 block mb-2" style={{ fontWeight: 550 }}>First Name</label>
                <input value={formData.firstName} onChange={e => setFormData({ ...formData, firstName: e.target.value })} type="text" placeholder="John"
                  className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-[10px] text-[13px] outline-none focus:ring-[3px] focus:ring-indigo-500/10 focus:border-indigo-400/60 transition-all" />
              </div>
              <div>
                <label className="text-[12px] text-slate-600 block mb-2" style={{ fontWeight: 550 }}>Last Name</label>
            ...
            <div>
              <label className="text-[12px] text-slate-600 block mb-2" style={{ fontWeight: 550 }}>Email</label>
              <div className="relative">
                ...
                <input value={formData.email} onChange={e => setFormData({ ...formData, email: e.target.value })} type="email" placeholder="john@company.com"
                  className="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-[10px] text-[13px] outline-none focus:ring-[3px] focus:ring-indigo-500/10 focus:border-indigo-400/60 transition-all" />
              </div>
            </div>

            <div>
              <label className="text-[12px] text-slate-600 block mb-2" style={{ fontWeight: 550 }}>Organization</label>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input value={password} onChange={e => setPassword(e.target.value)} type={showPassword ? "text" : "password"} placeholder="Create a strong password"
                  className="w-full pl-10 pr-10 py-3 bg-slate-50 border border-slate-200 rounded-[10px] text-[13px] outline-none focus:ring-[3px] focus:ring-indigo-500/10 focus:border-indigo-400/60 transition-all" />
