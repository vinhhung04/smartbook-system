...
const navGroups = [
  {
    ...
    items: [
      ...
      { to: "/staff-tasks", icon: ClipboardList, labelKey: "sidebar.staff_tasks", access: ROUTE_ACCESS.staffTaskProgress, activeColor: "from-violet-500/15 to-fuchsia-500/10", textColor: "text-violet-700", iconBg: "bg-violet-500/10" },
